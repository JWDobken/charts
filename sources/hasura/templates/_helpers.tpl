...
hasuraService: {{ .Values.hasuraConfig.hasuraService }}
{{- end }}
...
*/}}
{{- define "hasura.configMapName" -}}
{{ include "hasura.fullname" . }}-config
{{- end }}

{{/*
Create the name of the Admin Secret
*/}}
{{- define "hasura.adminSecretName" -}}
{{ include "hasura.fullname" . }}-auth
{{- end }}
